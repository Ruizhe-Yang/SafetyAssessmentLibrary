...
block AfterFor "Single-shot duration after first rising trigger"
...
equation
  ...
  annotation(Icon(graphics={Text(extent={{-82,54},{82,28}}, textString="AFTER %duration", textColor={90,70,140})}), Documentation(info="<html><p>Selects only the first [triggerTime,triggerTime+duration) domain.</p></html>"));
end AfterFor;