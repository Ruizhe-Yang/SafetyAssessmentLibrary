...
equation
  ...
  annotation(defaultComponentName="firstRecoveryWithin",Icon(graphics={Text(extent={{-82,40},{82,-36}},textString="OUT->IN",textColor={40,105,65},textStyle={TextStyle.Bold})}),Documentation(info="<html><p><b>Meaning:</b> after the first violation of each level, recovery shall occur within <code>maxRecoveryDuration</code>; an optional minimum continuous safe dwell may also be required.</p><p>This is violation-to-recovery semantics. For external trigger-to-response semantics use <code>TriggeredResponseWithin</code>.</p></html>"));
