...
package Results "White-box implementation of the Q layer"
  ...
  equation
    ...
    evidence.insideFraction=evaluation.insideFraction;
    evidence.longestInsideDuration=evaluation.longestInsideDuration;
    evidence.firstViolationTimeByLevel=evaluation.firstViolationTime;
    evidence.firstRecoveryTimeByLevel=evaluation.firstRecoveryTime;
    evidence.recoveryDurationByLevel=evaluation.recoveryDuration;
    evidence.postRecoverySafeDwell=evaluation.postRecoverySafeDwell;
    evidence.triggerTime=evaluation.triggerTime;
    evidence.responseTime=evaluation.responseTime;
    evidence.responseDuration=evaluation.responseDuration;
  ...
  equation
    ...
    result.insideFraction=evidence.insideFraction;
    result.longestInsideDuration=evidence.longestInsideDuration;
    result.firstViolationTimeByLevel=evidence.firstViolationTimeByLevel;
    result.firstRecoveryTimeByLevel=evidence.firstRecoveryTimeByLevel;
    result.recoveryDurationByLevel=evidence.recoveryDurationByLevel;
    result.postRecoverySafeDwell=evidence.postRecoverySafeDwell;
    result.triggerTime=evidence.triggerTime;
    result.responseTime=evidence.responseTime;
    result.responseDuration=evidence.responseDuration;
